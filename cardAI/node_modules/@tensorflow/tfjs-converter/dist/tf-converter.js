    ...
    ***************************************************************************** */
    ...
    var TensorArray = (function () {
        ...
        TensorArray.prototype.write = function (index, tensor) {
            ...
            tfc.util.assertShapesMatch(this.elementShape, tensor.shape, "TensorArray " + this.name + ": Could not write to TensorArray index " + index + ".");
            if (t && t.read) {
        ...
        TensorArray.prototype.gather = function (indices, dtype) {
            ...
            tfc.util.assertShapesMatch(this.elementShape, tensors[0].shape, 'TensorArray shape mismatch: ');
        ...
        TensorArray.prototype.concat = function (dtype) {
            ...
            var tensors = this.readMany(indices);
            tfc.util.assertShapesMatch(this.elementShape, tensors[0].shape, "TensorArray shape mismatch: tensor array shape (" + this.elementShape + ") vs first tensor shape (" + tensors[0].shape + ")");
        ...
        GraphExecutor.prototype.execute = function (inputs, outputs) {
            ...
            var result = tfc.tidy(function () {
                ...
                var tensors = _this.compiledOrder.reduce(function (map, node) {
                    map[node.name] = executeOp$15(node, map, context);
                    return map;
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            tensors = executeOp$15(item.node, tensorMap, context);
                            if (!nodeName) {
                                nodeName = getNodeNameAndIndex(item.node.name, context)[0];
                            }
                            _a = tensorMap;
